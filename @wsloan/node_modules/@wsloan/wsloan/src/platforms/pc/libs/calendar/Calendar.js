function Calendar (objName) {
    this.style = {
        ...
        borderColor: "#fddcda" , //边框颜色
        headerBackColor: "#ffffff" , //表头背景颜色
        headerFontColor: "#2e2e2e" , //表头字体颜色
        bodyBarBackColor: "#f74e48" , //日历标题背景色
        bodyBarFontColor: "#fff" , //日历标题字体色
        bodyBackColor: "#ffffff" , //日历背景色
        bodyFontColor: "#000000" , //日历字体色
        bodyBarFooterBackColor:'#fdfdfd', //表尾背景颜色
        bodyBarFooterFontColor:'#000000',//表尾字体颜色
        bodyHolidayFontColor: "#f74e48" , //假日字体色
...
Calendar.prototype.getStyle = function () {
    ...
    str += '.cdrBodyBarFooter{background-color:' + this.style.bodyBarFooterBackColor + ';font-size:12px;color:' + this.style.bodyBarFooterFontColor + ';width:140px;height:20px;}\n';
    str += '.cdrBody{width:140px;height:122px!important; height /**/:110px;font-size:12px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
    str += '.dayOver{height:16px;padding:0px;border:none;border-radius:100%;background-color:#f4f4f4;text-align:center;}\n';
    str += '.dayOut{padding:1px;border:none;height:16px;text-align:center;}\n';
    str += '.menuOver{background-color:' + this.style.headerBackColor + ';color:' + this.style.headerFontColor + ';font-size:12px;}\n';
    str += '.headerOver{border:none;background-color:#f4f4f4;color:black;cursor:default;}\n';
...
Calendar.prototype.getBody = function () {
    ...
    str += '</table>\n';
    str += '<table Author="alin" class="cdrBodyBar cdrBodyBarFooter" cellSpacing="2" cellPadding="0"><tr align="center" Author="alin"><td Author="alin" style="cursor:pointer;" onclick="' + this.Obj + '.getToday();">今天：' + new Date ().toFormatString ("yyyy年mm月dd日") + '</td></tr></table>\n';
    return str;
};
