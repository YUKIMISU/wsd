function Calendar (objName) {
    this.style = {
        ...
        borderColor: "#ff6461" , //边框颜色
        headerBackColor: "#ff6461" , //表头背景颜色
...
Calendar.prototype.getStyle = function () {
    ...
    str += '.dayOver{height:16px;padding:0px;border:1px solid #c0c0c0;background-color:#f4f4f4;text-align:center;}\n';
